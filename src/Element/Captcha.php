...
/**
 * Provides a captcha form element to insert in protected forms.
 *
 * @FormElement("captcha")
 */
class Captcha extends Element\FormElement {

  public function getInfo() {
    $class = get_class($this);
    $element =  array(
      '#input' => TRUE,
      '#process' => [$class, 'captcha_element_process'],
    ...
    if (CAPTCHA_DEFAULT_VALIDATION_CASE_INSENSITIVE == \Drupal::config('captcha.settings')->get('default_validation')) {
      $element['#captcha_validate'] = 'captcha_validate_case_insensitive_equality';
    }
  }
